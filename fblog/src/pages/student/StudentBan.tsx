...
export default function StudentUnban() {
  ...
  const { runAsync: unbanStudent } = useRequest(api.banStudent, {
    manual: true,
    onSuccess: (res) => {
      if (res) {
        message.success('Ban student success')
        submit()
      }
    },
    onError: (err) => {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    {
      title: 'Approved Report Post',
      key: 'successReportedTimes',
      dataIndex: 'successReportedTimes'
    },
    {
      title: 'Action',
      key: 'action',
